                        ...
                        angular.forEach(rows, function (row, i) {
                            ...
                            if (i !== 1) {
                                angular.forEach(tds, function (td) {
                                    ...
                                    rowData += stringify(angular.element(td).text()) + Array.apply(null, Array(td.colSpan)).map(function () { //jshint ignore:line
                                        return delimiter;
                                    }).join('');
                                });
                        ...
                        generate: function (filename) {
                            ...
                            if (cnt < total) {
                                var $off = settings.$scope.$on('ngTableAfterReloadData', function () {
                                    ...
                                    $off = settings.$scope.$on('ngRepeatFinished', function () {
                                        $off();
